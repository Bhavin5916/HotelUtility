...
Public Class Bill_CrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Form1.Bill_CrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBill_CrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bill_CrystalReport = New Bill_CrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
