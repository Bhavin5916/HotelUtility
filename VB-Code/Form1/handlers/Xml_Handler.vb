...
Public Class Xml_Handler
    Dim file_path = "D:\0824\Xml_files"
    Public Sub Create_xml_firsttime(ByVal p1 As String)
    ...
    Public Sub create_tableXml(ByVal p1 As String)
        Dim table_xml As String
        table_xml = p1
        Dim wrt_set As XmlWriterSettings = New XmlWriterSettings()
        wrt_set.Indent = True
    ...
    Public Sub addnew_row(ByVal p1 As String)
        Dim table_xml As String
    ...
    Public Sub bind_gridview_from_xml(ByVal p1 As String)
